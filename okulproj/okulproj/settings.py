...
SECRET_KEY = 'django-insecure-_1u8tt^_apmyco&03^6*8v5)r2rj=94#hu16-7g!=hmy8^xa2a'
...
WSGI_APPLICATION = 'okulproj.wsgi.application'
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.mysql",   #değişti
        ...
        # SSL sorununu çözmek için bu opsiyonu ekliyoruz
        "OPTIONS": {
            "init_command": "SET sql_mode='STRICT_TRANS_TABLES'",
            "ssl": {"disabled": True}  # SSL'i kapatıyoruz
        },
    }
    }
...
AUTH_USER_MODEL = "accounts.User"   #burası CustomUser modeli için 
