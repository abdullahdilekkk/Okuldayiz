# Generated by Django 5.2.7 on 2026-01-12 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User'), ('owner', 'Okul Sahibi')], default='user', max_length=155)),
                ('verification_code', models.CharField(blank=True, max_length=155, null=True)),
