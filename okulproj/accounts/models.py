...
class User(AbstractUser):
    ...
    email = models.TextField(unique=True)   #Tek email = True
    ...
    city = models.ForeignKey(City, on_delete=models.SET_NULL)   #olamzsa kaydım NULL yap beni direkt silme demek
